...
import {Snippet, StyledSnippetPre, globalCss, StyledSnippetCopyButton} from "@nextui-org/react";
import {makeCodeTheme} from "./theme";
...
const CodeBlock: React.FC<PropsWithChildren<Prop>> = ({children}) => {
